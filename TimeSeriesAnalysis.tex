...
\chapter{Giới thiệu Python và các công cụ hỗ trợ}\label{giux1a1i-thiuxeau-python-va-cac-cuxf4ng-cu-huxf4-trux1a1}

\chapter{Lập trình với ngôn ngữ Python}\label{lux1eadp-truxecnh-vux1edbi-nguxf4n-ngux1eef-python}

\section{Nội dung buổi học}\label{nux1ed9i-dung-buux1ed5i-hux1ecdc}

\begin{itemize}
\item
  Giới thiệu các biến trong Python\hspace{0pt}
\item
